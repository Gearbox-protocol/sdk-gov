...
contract TokensDataLive {
    ...
    constructor() {
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                id: Tokens.sdGHOV3,
                addr: 0x580e39ADb33E106fFc2712cBD57B9cE954dcfE75,
                symbol: "sdGHOV3",
                tokenType: TokenType.DIESEL_LP_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                id: Tokens.sdDAIV3,
                addr: 0x7aB44F17EE21A3D6Bb2aeb1c6cA8B875041608C4,
                symbol: "sdDAIV3",
                tokenType: TokenType.DIESEL_LP_TOKEN
            })
        );
        ...
        tokenDataByNetwork[42161].push(
            TokenData({
                id: Tokens.aurawstETH_rETH_sfrxETH,
        ...
        tokenDataByNetwork[42161].push(
            TokenData({
                id: Tokens.aurawstETH_WETH_BPT_vault,
        ...
        tokenDataByNetwork[42161].push(
            TokenData({
                id: Tokens.aurawstETH_rETH_sfrxETH_vault,
