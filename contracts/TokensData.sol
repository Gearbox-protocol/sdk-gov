    ...
    constructor() {
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x117A0bab81F25e60900787d98061cCFae023560c,
                symbol: "cvxcrvFRAX",
                tokenType: TokenType.CONVEX_LP_TOKEN
            })
        );
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0xd8F1B275c320819c7D752ef79988d0780bf00446,
                symbol: "cvxOHMFRAXBP",
                tokenType: TokenType.CONVEX_LP_TOKEN
            })
        );
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x0Fb8dcdD95e4C48D3dD0eFA4086512f6F8FD4565,
                symbol: "cvxcrvCRVETH",
                tokenType: TokenType.CONVEX_LP_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x0bC857f97c0554d1d0D602b56F2EEcE682016fBA,
                symbol: "cvxcrvCVXETH",
                tokenType: TokenType.CONVEX_LP_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0xB77BA8B4b9d981269466eE95796A9Af57d4E82DB,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                id: Tokens.cvxLDOETH,
                address: 0x4eBE557ae39F87D2a014719777FD4cF4d01Dc8Ee,
                symbol: "cvxLDOETH",
                tokenType: TokenType.CONVEX_LP_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0xbAc7a431146aeAf3F57A16b9954f332Fd292F270,
                symbol: "stkcvx3Crv",
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x276187f24D41745513cbE2Bd5dFC33a4d8CDc9ed,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0xe15B7D80a51e1fe54aC355CaBE848Efce5289BDB,
                symbol: "stkcvxsteCRV",
                tokenType: TokenType.CONVEX_STAKED_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0xaF314b088B53835d5cF4e4CB81beABa5934a61fe,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x0A1D4A25d0390899b90bCD22E1Ef155003EA76d7,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x7e1992A7F28dAA5f6a2d34e2cd40f962f37B172C,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x34fB99abBAFb4e87e256960D572664c6ADc301B8,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x888407AabAfa936B90acF65C4Db19370A01d9bd8,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x1aAbe1B22a290cCB39FD77440D5eb96Cf40079f4,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0xfC4b109D46e12170DF31AF8ba39403fAC2b8c0cf,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x948bEd0211076b05d22e98929217d0f04D068C5c,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0xEE3EE8373384BBfea3227E527C1B9b4e7821273E,
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                ...
                address: 0x2Fd6bD5b81c1060039D619E76e4e1f924B173006,
                symbol: "stkcvxLDOETH",
                tokenType: TokenType.CONVEX_STAKED_TOKEN
            })
        );
        ...
        tokenDataByNetwork[1].push(
            TokenData({
                id: Tokens.dWBTC,
                address: 0xe753260F1955e8678DCeA8887759e07aa57E8c54,
                symbol: "dWBTC",
                tokenType: TokenType.DIESEL_LP_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                id: Tokens.dWETH,
                address: 0xF21fc650C1B34eb0FDE786D52d23dA99Db3D6278,
                symbol: "dWETH",
                tokenType: TokenType.DIESEL_LP_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                id: Tokens.dwstETH,
                address: 0x2158034dB06f06dcB9A786D2F1F8c38781bA779d,
                symbol: "dwstETH",
                tokenType: TokenType.DIESEL_LP_TOKEN
            })
        );
        tokenDataByNetwork[1].push(
            TokenData({
                id: Tokens.dFRAX,
                address: 0x8A1112AFef7F4FC7c066a77AABBc01b3Fff31D47,
                symbol: "dFRAX",
                tokenType: TokenType.DIESEL_LP_TOKEN
            })
        );
