...
// ------------------------ LQTY ------------------------
zeroPriceFeedsByNetwork[1].push(SingeTokenPriceFeedData({ token: Tokens.LQTY }));zeroPriceFeedsByNetwork[42161].push(SingeTokenPriceFeedData({ token: Tokens.LQTY }));
...
// ------------------------ SHIB ------------------------
redStonePriceFeedsByNetwork[1].push(RedStonePriceFeedData({ 
            token: Tokens.SHIB,
            tokenSymbol: "SHIB", 
            dataFeedId: "redstone-main-demo", signers: [0x0C39486f770B26F5527BBBf942726537986Cd7eb,address(0),address(0),address(0),address(0),address(0),address(0),address(0),address(0),address(0)], signersThreshold: 1 }));redStonePriceFeedsByNetwork[42161].push(RedStonePriceFeedData({ 
            token: Tokens.SHIB,
            tokenSymbol: "SHIB", 
            dataFeedId: "redstone-main-demo", signers: [0x0C39486f770B26F5527BBBf942726537986Cd7eb,address(0),address(0),address(0),address(0),address(0),address(0),address(0),address(0),address(0)], signersThreshold: 1 }));
...
// ------------------------ yvDAI ------------------------
yearnPriceFeedsByNetwork[1].push(SingeTokenPriceFeedData({ token: Tokens.yvDAI }));yearnPriceFeedsByNetwork[42161].push(SingeTokenPriceFeedData({ token: Tokens.yvDAI }));

// ------------------------ yvUSDC ------------------------
yearnPriceFeedsByNetwork[1].push(SingeTokenPriceFeedData({ token: Tokens.yvUSDC }));yearnPriceFeedsByNetwork[42161].push(SingeTokenPriceFeedData({ token: Tokens.yvUSDC }));

// ------------------------ yvWETH ------------------------
yearnPriceFeedsByNetwork[1].push(SingeTokenPriceFeedData({ token: Tokens.yvWETH }));yearnPriceFeedsByNetwork[42161].push(SingeTokenPriceFeedData({ token: Tokens.yvWETH }));

// ------------------------ yvWBTC ------------------------
yearnPriceFeedsByNetwork[1].push(SingeTokenPriceFeedData({ token: Tokens.yvWBTC }));yearnPriceFeedsByNetwork[42161].push(SingeTokenPriceFeedData({ token: Tokens.yvWBTC }));

// ------------------------ 3Crv ------------------------
curvePriceFeedsByNetwork[1].push(CurvePriceFeedData({
        lpToken: Tokens._3Crv,
        assets: TokensLib.arrayOf(Tokens.DAI, Tokens.USDC, Tokens.USDT),
        pool: Contracts.CURVE_3CRV_POOL
      }));curvePriceFeedsByNetwork[42161].push(CurvePriceFeedData({
        lpToken: Tokens._3Crv,
        assets: TokensLib.arrayOf(Tokens.DAI, Tokens.USDC, Tokens.USDT),
        pool: Contracts.CURVE_3CRV_POOL
      }));
...
// ------------------------ OHMFRAXBP ------------------------
curveCryptoPriceFeedsByNetwork[1].push(CurvePriceFeedData({
        lpToken: Tokens.OHMFRAXBP,
        assets: TokensLib.arrayOf(Tokens.OHM, Tokens.crvFRAX),
        pool: Contracts.CURVE_OHMFRAXBP_POOL
      }));curveCryptoPriceFeedsByNetwork[42161].push(CurvePriceFeedData({
        lpToken: Tokens.OHMFRAXBP,
        assets: TokensLib.arrayOf(Tokens.OHM, Tokens.crvFRAX),
        pool: Contracts.CURVE_OHMFRAXBP_POOL
      }));
...
// ------------------------ crvUSD ------------------------
crvUSDPriceFeedsByNetwork[1].push(CrvUsdPriceFeedData({ token: Tokens.crvUSD, 
      pool: Contracts.CURVE_CRVUSD_USDC_POOL,
      underlying: Tokens.USDC}));crvUSDPriceFeedsByNetwork[42161].push(CrvUsdPriceFeedData({ token: Tokens.crvUSD, 
      pool: Contracts.CURVE_CRVUSD_USDC_POOL,
...
// ------------------------ yvCurve_stETH ------------------------
yearnPriceFeedsByNetwork[1].push(SingeTokenPriceFeedData({ token: Tokens.yvCurve_stETH }));yearnPriceFeedsByNetwork[42161].push(SingeTokenPriceFeedData({ token: Tokens.yvCurve_stETH }));

// ------------------------ yvCurve_FRAX ------------------------
yearnPriceFeedsByNetwork[1].push(SingeTokenPriceFeedData({ token: Tokens.yvCurve_FRAX }));yearnPriceFeedsByNetwork[42161].push(SingeTokenPriceFeedData({ token: Tokens.yvCurve_FRAX }));

// ------------------------ cvx3Crv ------------------------
theSamePriceFeedsByNetwork[1].push(TheSamePriceFeedData({
    token: Tokens.cvx3Crv,
    tokenHasSamePriceFeed: Tokens._3Crv
  }));theSamePriceFeedsByNetwork[42161].push(TheSamePriceFeedData({
    token: Tokens.cvx3Crv,
    tokenHasSamePriceFeed: Tokens._3Crv
  }));
...
theSamePriceFeedsByNetwork[1].push(TheSamePriceFeedData({
    token: Tokens.aDAI,
    tokenHasSamePriceFeed: Tokens.DAI
  }));theSamePriceFeedsByNetwork[42161].push(TheSamePriceFeedData({
    token: Tokens.aDAI,
    tokenHasSamePriceFeed: Tokens.DAI
  }));
...
// ------------------------ waDAI ------------------------
wrappedAaveV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.waDAI, underlying: Tokens.aDAI}));wrappedAaveV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.waDAI, underlying: Tokens.aDAI}));

// ------------------------ waUSDC ------------------------
wrappedAaveV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.waUSDC, underlying: Tokens.aUSDC}));wrappedAaveV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.waUSDC, underlying: Tokens.aUSDC}));

// ------------------------ waUSDT ------------------------
wrappedAaveV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.waUSDT, underlying: Tokens.aUSDT}));wrappedAaveV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.waUSDT, underlying: Tokens.aUSDT}));

// ------------------------ waWETH ------------------------
wrappedAaveV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.waWETH, underlying: Tokens.aWETH}));wrappedAaveV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.waWETH, underlying: Tokens.aWETH}));

// ------------------------ cDAI ------------------------
compoundV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.cDAI, underlying: Tokens.DAI}));compoundV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.cDAI, underlying: Tokens.DAI}));

// ------------------------ cUSDC ------------------------
compoundV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.cUSDC, underlying: Tokens.USDC}));compoundV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.cUSDC, underlying: Tokens.USDC}));

// ------------------------ cUSDT ------------------------
compoundV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.cUSDT, underlying: Tokens.USDT}));compoundV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.cUSDT, underlying: Tokens.USDT}));

// ------------------------ cLINK ------------------------
compoundV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.cLINK, underlying: Tokens.LINK}));compoundV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.cLINK, underlying: Tokens.LINK}));

// ------------------------ cWETH ------------------------
compoundV2PriceFeedsByNetwork[1].push(GenericLPPriceFeedData({ lpToken: Tokens.cWETH, underlying: Tokens.WETH}));compoundV2PriceFeedsByNetwork[42161].push(GenericLPPriceFeedData({ lpToken: Tokens.cWETH, underlying: Tokens.WETH}));
