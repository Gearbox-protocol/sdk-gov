...
uint256 constant TOKEN_pumpBTCWBTC = 111;
uint256 constant TOKEN_TriBTC = 112;
uint256 constant TOKEN_FRAX3CRV = 113;
uint256 constant TOKEN_LUSD3CRV = 114;
uint256 constant TOKEN_gusd3CRV = 115;
uint256 constant TOKEN_cvx3Crv = 116;
uint256 constant TOKEN_cvxcrvFRAX = 117;
uint256 constant TOKEN_cvxsteCRV = 118;
uint256 constant TOKEN_cvxFRAX3CRV = 119;
uint256 constant TOKEN_cvxLUSD3CRV = 120;
uint256 constant TOKEN_cvxcrvPlain3andSUSD = 121;
uint256 constant TOKEN_cvxgusd3CRV = 122;
uint256 constant TOKEN_cvxcrvCRVETH = 123;
uint256 constant TOKEN_cvxcrvCVXETH = 124;
uint256 constant TOKEN_cvxcrvUSDTWBTCWETH = 125;
uint256 constant TOKEN_cvxLDOETH = 126;
uint256 constant TOKEN_cvxcrvUSDUSDC = 127;
uint256 constant TOKEN_cvxcrvUSDUSDT = 128;
uint256 constant TOKEN_cvxcrvUSDFRAX = 129;
uint256 constant TOKEN_cvxcrvUSDETHCRV = 130;
uint256 constant TOKEN_cvxGHOcrvUSD = 131;
uint256 constant TOKEN_stkcvx3Crv = 132;
uint256 constant TOKEN_stkcvxcrvFRAX = 133;
uint256 constant TOKEN_stkcvxsteCRV = 134;
uint256 constant TOKEN_stkcvxFRAX3CRV = 135;
uint256 constant TOKEN_stkcvxLUSD3CRV = 136;
uint256 constant TOKEN_stkcvxcrvPlain3andSUSD = 137;
uint256 constant TOKEN_stkcvxgusd3CRV = 138;
uint256 constant TOKEN_stkcvxcrvCRVETH = 139;
uint256 constant TOKEN_stkcvxcrvCVXETH = 140;
uint256 constant TOKEN_stkcvxcrvUSDTWBTCWETH = 141;
uint256 constant TOKEN_stkcvxLDOETH = 142;
uint256 constant TOKEN_stkcvxcrvUSDUSDC = 143;
uint256 constant TOKEN_stkcvxcrvUSDUSDT = 144;
uint256 constant TOKEN_stkcvxcrvUSDFRAX = 145;
uint256 constant TOKEN_stkcvxcrvUSDETHCRV = 146;
uint256 constant TOKEN_stkcvxGHOcrvUSD = 147;
uint256 constant TOKEN_cvxcrvUSDT = 148;
uint256 constant TOKEN_yvDAI = 149;
uint256 constant TOKEN_yvUSDC = 150;
uint256 constant TOKEN_yvUSDC_e = 151;
uint256 constant TOKEN_yvWETH = 152;
uint256 constant TOKEN_yvWBTC = 153;
uint256 constant TOKEN_yvUSDT = 154;
uint256 constant TOKEN_yvOP = 155;
uint256 constant TOKEN_yvCurve_stETH = 156;
uint256 constant TOKEN_yvCurve_FRAX = 157;
uint256 constant TOKEN__50WETH_50AURA = 158;
uint256 constant TOKEN_B_80BAL_20WETH = 159;
uint256 constant TOKEN_USDC_DAI_USDT = 160;
uint256 constant TOKEN_B_rETH_STABLE = 161;
uint256 constant TOKEN_weETH_rETH = 162;
uint256 constant TOKEN_osETH_wETH_BPT = 163;
uint256 constant TOKEN_ezETH_WETH_BPT = 164;
uint256 constant TOKEN_sUSDe_USDC_BPT = 165;
uint256 constant TOKEN_pumpBTC_WBTC_BPT = 166;
...
uint256 constant TOKEN_scrvUSD = 203;
uint256 constant TOKEN_auraB_rETH_STABLE = 204;
uint256 constant TOKEN_auraosETH_wETH_BPT = 205;
uint256 constant TOKEN_auraweETH_rETH = 206;
uint256 constant TOKEN_auraBPT_rETH_ETH = 207;
uint256 constant TOKEN_auraBPT_WSTETH_ETH = 208;
uint256 constant TOKEN_aurawstETH_WETH_BPT = 209;
uint256 constant TOKEN_aurawstETH_rETH_sfrxETH = 210;
uint256 constant TOKEN_auracbETH_rETH_wstETH = 211;
uint256 constant TOKEN_aurarETH_wETH_BPT = 212;
uint256 constant TOKEN_auraB_rETH_STABLE_vault = 213;
uint256 constant TOKEN_auraosETH_wETH_BPT_vault = 214;
uint256 constant TOKEN_auraweETH_rETH_vault = 215;
uint256 constant TOKEN_auraBPT_rETH_ETH_vault = 216;
uint256 constant TOKEN_auraBPT_WSTETH_ETH_vault = 217;
uint256 constant TOKEN_aurawstETH_WETH_BPT_vault = 218;
uint256 constant TOKEN_aurawstETH_rETH_sfrxETH_vault = 219;
uint256 constant TOKEN_auracbETH_rETH_wstETH_vault = 220;
uint256 constant TOKEN_aurarETH_wETH_BPT_vault = 221;
uint256 constant TOKEN_zpufETH = 222;
uint256 constant TOKEN_stkUSDS = 223;
uint256 constant TOKEN_dDAI = 224;
uint256 constant TOKEN_dUSDC = 225;
uint256 constant TOKEN_dWBTC = 226;
uint256 constant TOKEN_dWETH = 227;
uint256 constant TOKEN_dwstETH = 228;
uint256 constant TOKEN_dFRAX = 229;
uint256 constant TOKEN_dUSDCV3 = 230;
uint256 constant TOKEN_dUSDC_eV3 = 231;
uint256 constant TOKEN_dWBTCV3 = 232;
uint256 constant TOKEN_dWETHV3 = 233;
uint256 constant TOKEN_dUSDTV3 = 234;
uint256 constant TOKEN_dGHOV3 = 235;
uint256 constant TOKEN_dDAIV3 = 236;
uint256 constant TOKEN_dcrvUSDV3 = 237;
uint256 constant TOKEN_dDOLAV3 = 238;
uint256 constant TOKEN_sdUSDCV3 = 239;
uint256 constant TOKEN_sdUSDC_eV3 = 240;
uint256 constant TOKEN_sdWBTCV3 = 241;
uint256 constant TOKEN_sdWETHV3 = 242;
uint256 constant TOKEN_sdWETHV3_OLD = 243;
uint256 constant TOKEN_sdUSDTV3 = 244;
uint256 constant TOKEN_sdGHOV3 = 245;
uint256 constant TOKEN_sdDAIV3 = 246;
uint256 constant TOKEN_sdcrvUSDV3 = 247;
uint256 constant TOKEN_sdDOLAV3 = 248;
uint256 constant TOKEN_GEAR = 249;
uint256 constant NUM_TOKENS = 250;
