...
uint256 constant TOKEN_rsETH_wETH_Arb = 180;
uint256 constant TOKEN_BPT_rETH_ETH = 181;
uint256 constant TOKEN_BPT_WSTETH_ETH = 182;
uint256 constant TOKEN_BPT_ROAD = 183;
uint256 constant TOKEN_ECLP_wstETH_WETH = 184;
uint256 constant TOKEN_wstETH_WETH_BPT = 185;
uint256 constant TOKEN_wstETH_rETH_sfrxETH = 186;
uint256 constant TOKEN_wstETH_rETH_cbETH = 187;
uint256 constant TOKEN_cbETH_rETH_wstETH = 188;
uint256 constant TOKEN_rETH_WETH_BPT_deprecated = 189;
uint256 constant TOKEN_rETH_wETH_BPT = 190;
uint256 constant TOKEN__33AURA_33ARB_33BAL = 191;
uint256 constant TOKEN_ezETH_wstETH = 192;
uint256 constant TOKEN_bpt_ethtri = 193;
...
uint256 constant TOKEN_auraB_rETH_STABLE = 213;
uint256 constant TOKEN_auraosETH_wETH_BPT = 214;
uint256 constant TOKEN_auraweETH_rETH = 215;
uint256 constant TOKEN_auraBPT_rETH_ETH = 216;
uint256 constant TOKEN_auraBPT_WSTETH_ETH = 217;
uint256 constant TOKEN_aurawstETH_WETH_BPT = 218;
uint256 constant TOKEN_aurawstETH_rETH_sfrxETH = 219;
uint256 constant TOKEN_auracbETH_rETH_wstETH = 220;
uint256 constant TOKEN_aurarETH_wETH_BPT = 221;
uint256 constant TOKEN_auraB_rETH_STABLE_vault = 222;
uint256 constant TOKEN_auraosETH_wETH_BPT_vault = 223;
uint256 constant TOKEN_auraweETH_rETH_vault = 224;
uint256 constant TOKEN_auraBPT_rETH_ETH_vault = 225;
uint256 constant TOKEN_auraBPT_WSTETH_ETH_vault = 226;
uint256 constant TOKEN_aurawstETH_WETH_BPT_vault = 227;
uint256 constant TOKEN_aurawstETH_rETH_sfrxETH_vault = 228;
uint256 constant TOKEN_auracbETH_rETH_wstETH_vault = 229;
uint256 constant TOKEN_aurarETH_wETH_BPT_vault = 230;
uint256 constant TOKEN_zpufETH = 231;
uint256 constant TOKEN_stkUSDS = 232;
uint256 constant TOKEN_dDAI = 233;
uint256 constant TOKEN_dUSDC = 234;
uint256 constant TOKEN_dWBTC = 235;
uint256 constant TOKEN_dWETH = 236;
uint256 constant TOKEN_dwstETH = 237;
uint256 constant TOKEN_dFRAX = 238;
uint256 constant TOKEN_dDOLAV3 = 239;
uint256 constant TOKEN_dtBTCV3 = 240;
uint256 constant TOKEN_dwstETHV3 = 241;
uint256 constant TOKEN_dUSDCV3 = 242;
uint256 constant TOKEN_dUSDC_eV3 = 243;
uint256 constant TOKEN_dWBTCV3 = 244;
uint256 constant TOKEN_dWETHV3 = 245;
uint256 constant TOKEN_dUSDTV3 = 246;
uint256 constant TOKEN_dGHOV3 = 247;
uint256 constant TOKEN_dDAIV3 = 248;
uint256 constant TOKEN_dcrvUSDV3 = 249;
uint256 constant TOKEN_sdUSDCV3 = 250;
uint256 constant TOKEN_sdUSDC_eV3 = 251;
uint256 constant TOKEN_sdWBTCV3 = 252;
uint256 constant TOKEN_sdWETHV3 = 253;
uint256 constant TOKEN_sdWETHV3_OLD = 254;
uint256 constant TOKEN_sdUSDTV3 = 255;
uint256 constant TOKEN_sdGHOV3 = 256;
uint256 constant TOKEN_sdDAIV3 = 257;
uint256 constant TOKEN_sdcrvUSDV3 = 258;
uint256 constant TOKEN_GEAR = 259;
uint256 constant NUM_TOKENS = 260;
