...
uint256 constant TOKEN_dUSDCV3 = 264;
uint256 constant TOKEN_dUSDC_eV3 = 265;
uint256 constant TOKEN_dWBTCV3 = 266;
uint256 constant TOKEN_dWETHV3 = 267;
uint256 constant TOKEN_dUSDTV3 = 268;
uint256 constant TOKEN_dGHOV3 = 269;
uint256 constant TOKEN_dDAIV3 = 270;
uint256 constant TOKEN_dcrvUSDV3 = 271;
uint256 constant TOKEN_sdUSDCV3 = 272;
uint256 constant TOKEN_sdUSDC_eV3 = 273;
uint256 constant TOKEN_sdWBTCV3 = 274;
uint256 constant TOKEN_sdWETHV3 = 275;
uint256 constant TOKEN_sdWETHV3_OLD = 276;
uint256 constant TOKEN_sdUSDTV3 = 277;
uint256 constant TOKEN_sdGHOV3 = 278;
uint256 constant TOKEN_sdDAIV3 = 279;
uint256 constant TOKEN_sdcrvUSDV3 = 280;
uint256 constant TOKEN_GEAR = 281;
uint256 constant NUM_TOKENS = 282;
